"""Live viser for the fem_rigid / abd / fem cube materials (Stages 3–5).
...
Switch the cube material (fem_rigid → abd → fem) and the device (cpu / cuda:0)
from the GUI; the scene rebuilds.
