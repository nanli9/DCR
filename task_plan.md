...
| F | in_progress | E0 packet (clean-checkout smoke) + video (§12, ~2/3 new footage) | E0 supplement DONE (synced to reorg, smoke PASS, SHA256SUMS 63/63); video = asset inventory written (`docs/mig2026_video_asset_inventory.md`), render pending; acmSubmissionID blocked till EasyChair opens 07-25 |
