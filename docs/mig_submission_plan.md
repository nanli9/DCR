...
|---|---|---|
| W4 | MIG/acmart format conversion | **DONE** — builds 6 pp, anonymous+line numbers, wide tables→`table*`, wide figs→`figure*`, 4 overwide equations reflowed, `\Description` added. Residual: 7 minor overfulls (≤18.6 pt), teaser missing, ORCID placeholder, EasyChair ID placeholder |
