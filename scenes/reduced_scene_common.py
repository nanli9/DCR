...
def build_support_and_attach(
    ...
    *,
    ...
    if solver in ("avbd", "native", "xpbd"):
        ...
        # Transitional: the AVBD reduced *coupler* (external hook), kept for
        # parity/benchmark comparison until Stage 6 removes the coupler. The
        # native AVBD path above ("avbd") is the production path now.
