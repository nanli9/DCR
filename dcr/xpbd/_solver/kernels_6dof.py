...
def solve_floor_contacts(
    ...
    floor_disabled: wp.array(dtype=int),  # 1 ⇒ skip global floor for body i (e.g. tracked by a reduced-coupled coupler that handles its own per-corner anchor)
    floor_y: float,
    mu_s: float,
